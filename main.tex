...
\hlcom{#plot(seq(mresid), mresid, xlab = "time", ylab = "Martingale Residuals")}
\hlkwd{qqnorm}\hldef{(dresid,} \hlkwc{xlab} \hldef{=} \hlsng{"time"}\hldef{,} \hlkwc{ylab} \hldef{=} \hlsng{"Deviance Residuals"}\hldef{)}
